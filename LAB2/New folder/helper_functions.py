...
def printForm(dict):
    for i in dict:
        ...
        for j in items:
            print(j ["Receipt No"],end = ", ")
            print(j ["Invoice No"],end = "  ,  ")
            print(j ["Date"],end = "  ,       ")
...
def  printReceipt(dict):
    ...
    print("Payment Reference",end = ", ")
    print("Remarks",end = ", ")
    print("Total Received",end = ", ")
    print("Receipt Line Item")
    ...
    for i in dict:
        print(" ")
        print(i ["Receipt No"],end = ", ")
        print(i ["Date"],end = ", ")
        print(i ["Customer Code"],end = ", ")
        print(i ["Customer Name"],end = ", ")
        print(i ["Payment Method"],end = ", ")
        print(i ["Payment Reference"],end = ", ")
        print(i ["Remarks"],end = ", ")
        print(i ["Total Received"],end = ", ")
        print(i ["Receipt Line Item"])
