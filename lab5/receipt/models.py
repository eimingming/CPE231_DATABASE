...
class PaymentMedthod(models.Model):
    payment_method_code = models.CharField(max_length=5, primary_key=True)
    payment_method_name = models.CharField(max_length=20, null=True)
...
class Receipt(models.Model):
    ...
    customer_code = models.ForeignKey(Customer, on_delete=models.CASCADE, db_column='customer_code')
    payment_method_code = models.ForeignKey(PaymentMedthod, on_delete=models.CASCADE, db_column='payment_method_code')
