...
#main function begins here
    try:
        ...
        """
        products = Product()
        update_product(products, "HD01", "Seagate HDD 80 GB", "500")
        update_product(products, "HD02", "IBM HDD 60 GB", "600")
        update_product(products, "INT01", "Intel Pentium IV 3.6 GHz", "1200")
